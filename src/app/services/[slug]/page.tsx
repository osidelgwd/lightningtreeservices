...
const allServicesInfo: Record<string, ServiceDetailsProps> = {
    "tree-trimming-pruning": {
        ...
        video: {
            ...
            backgroundImage: "https://gwd-website.b-cdn.net/lightning/WhatsApp%20Image%202026-04-10%20at%206.43.46%20AM.jpeg",
        },
        cta: {
    ...
    "yard-clean-up": {
        ...
        video: {
            videoUrl: "https://gwd-website.b-cdn.net/lightning/videoeditado-01.mp4",
            backgroundImage: "https://gwd-website.b-cdn.net/lightning/banner-4444.jpeg",
        },
        cta: {
    ...
    "blackberry-removal": {
        ...
        video: {
            videoUrl: "https://gwd-website.b-cdn.net/lightning/videoeditado-01.mp4",
            backgroundImage: "https://gwd-website.b-cdn.net/lightning/bladsshshss.jpeg",
        },
        cta: {
    ...
    "sod-grass-installation": {
        ...
        video: {
            videoUrl: "https://gwd-website.b-cdn.net/lightning/videoeditado-01.mp4",
            backgroundImage: "https://gwd-website.b-cdn.net/lightning/sdsasdasdsad.jpeg",
        },
        cta: {
...
// --- STATIC PARAMS FOR VERCEL ---
export async function generateStaticParams() {
    return [
        { slug: "tree-trimming-pruning" },
        { slug: "tree-removal" },
        { slug: "fruit-tree-care" },
        { slug: "yard-clean-up" },
        { slug: "blackberry-removal" },
        { slug: "sod-grass-installation" },
        { slug: "river-rock-gravel" },
        { slug: "fences-and-pavers" },
    ];
}
...
export default async function ServiceDetailsPage({ 
    ...
    // Esta línea asegura que el slug se lea correctamente si es una Promesa (Next 15)
    // o un objeto plano (Next 14/Local).
    const resolvedParams = await (params instanceof Promise ? params : Promise.resolve(params));
    const slug = resolvedParams.slug;

    // Buscamos la data
    const currentServiceData = allServicesInfo[slug];

    // Si no existe el slug, podrías mostrar un 404 real o el defecto
    const dataToRender = currentServiceData || allServicesInfo["tree-removal"];
    return (
